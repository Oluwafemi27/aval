## API Report File for "@aval/player-web"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import type { AccessUnitRecord } from '@aval/format';
import type { AvcCodecV01 } from '@aval/format';
import { AvcConstrainedBaselineProfile } from '@aval/format';
import type { AvcQuantizationPolicy } from '@aval/format';
import { AvcRenditionGeometry } from '@aval/format';
import { AvcRenditionInspection } from '@aval/format';
import { BindingSourceV01 } from '@aval/format';
import { BindingV01 } from '@aval/format';
import type { ByteRange } from '@aval/format';
import { CanvasV01 } from '@aval/format';
import { CompiledManifestV01 } from '@aval/format';
import { EdgeV01 } from '@aval/format';
import { FormatHeader } from '@aval/format';
import { GraphBodyDefinition } from '@aval/graph';
import { GraphEdgeDefinition } from '@aval/graph';
import type { GraphPresentation } from '@aval/graph';
import type { GraphSettlementError } from '@aval/graph';
import { GraphStartPolicy } from '@aval/graph';
import type { GraphStateDefinition } from '@aval/graph';
import { IDENTIFIER_PATTERN } from '@aval/format';
import type { MotionGraphEffect } from '@aval/graph';
import type { MotionGraphOperation } from '@aval/graph';
import type { MotionGraphReadiness } from '@aval/graph';
import type { MotionGraphResult } from '@aval/graph';
import type { MotionGraphSnapshot } from '@aval/graph';
import type { MotionGraphTickOptions } from '@aval/graph';
import { ParsedFrontIndex } from '@aval/format';
import type { PortV01 } from '@aval/format';
import { RenditionV01 } from '@aval/format';
import type { ResidencyEndpointV01 } from '@aval/format';
import { StateV01 } from '@aval/format';
import type { UnitBlobRange } from '@aval/format';
import { UnitV01 } from '@aval/format';
import { ValidatedAssetLayout } from '@aval/format';
