## API Report File for "@aval/element"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import type { BindingV01 } from '@aval/player-web';
import type { MotionPolicy } from '@aval/player-web';
import type { RuntimeFailureCode } from '@aval/player-web';
import type { RuntimeReadiness } from '@aval/player-web';
import type { RuntimeReadinessResult } from '@aval/player-web';
import type { StaticReason } from '@aval/player-web';
