...
describe("M4 checked-in conformance fixtures", () => {
  ...
  it("documents M4's deferred digest, PNG CRC, and RGBA-content verification", () => {
    ...
    bytes[firstStatic.offset + 32] = (bytes[firstStatic.offset + 32] ?? 0) ^ 0xff;
