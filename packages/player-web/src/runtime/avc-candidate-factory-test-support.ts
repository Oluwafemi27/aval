...
export function disposeAvcCandidateTestCatalogs(): void {
...
export function createContexts(hostMaxRuntimeBytes: number | null = null): CandidateContexts {
  ...
  const candidates = createAvcRenditionCandidates(catalog.renditions.values());
...
export class LeakTracker {
  ...
  public readonly readinessInputs: Readonly<AvcCandidateReadinessSessionInput>[] = [];
  public readonly activationInputs: Readonly<AvcCandidateActivationInput>[] = [];
...
class FakeWorker implements AvcCandidateWorker {
...
class FakeRendererReservation implements AvcCandidateRendererReservation {
...
class FakeRendererBackend implements FrameRendererBackend {
  public readonly limits = Object.freeze({
    maxTextureSize: 4_096,
    maxArrayTextureLayers: 256
  });
  ...
  public upload(_kind: FrameTextureKind, _index: number, _pixels: Uint8Array): void {}
...
class FakeReadinessSession implements AvcCandidateReadinessSession {
  ...
  public async prepareActivation(
    ...
    if (this.#mode === "activation-pending") {
      ...
      return await never<AvcCandidatePreparedMedia>();
    }
...
class FakePreparedMedia implements AvcCandidatePreparedMedia {
...
class FakePlayback implements IntegratedPlaybackSession {
  readonly #input: Readonly<AvcCandidateActivationInput>;

  public constructor(input: Readonly<AvcCandidateActivationInput>) {
    this.#input = input;
  }
...
export class ManualTimers implements AvcCandidateTimerHost {
  #next = 1;
...
/** @deprecated Use disposeAvcCandidateTestCatalogs. */
export const disposeOpaqueCandidateTestCatalogs =
